...
selections=[('01-instances','^TestReleaseFlowBrowserSystemPath$'),('02-emergency','^TestReleaseEmergencyBrowserSystemPath$'),('03-notification-center','^TestNotificationCenterBrowserSystemPath$'),('04-release-notifications','^TestReleaseNotificationsBrowserSystemPath$'),('05-approval-notifications','^TestApprovalNotificationsBrowserSystemPath$'),('06-release-approvals','^TestAccountBrowserSystemPath$/^release-approvals\\.cjs$')]
def snapshot():
...
(evidence/'first-pass-results.json').write_text(json.dumps(all_results,indent=2)+'\n')
