...
selections=[('06a-fixture-diagnosis','^TestAccountBrowserSystemPath$/^fixture-diagnosis-only$')]
def snapshot():
...
(evidence/'06a-fixture-diagnosis-results.json').write_text(json.dumps(all_results,indent=2)+'\n')
