...
import { managedDataColumnTypeSchema } from "./contracts";
...
const fieldSchema = z.object({
  field_name: z.string(), column_type: managedDataColumnTypeSchema.or(z.literal("unsupported")), nullable: z.boolean(), generated: z.boolean(), auto_increment: z.boolean(), has_default: z.boolean(),
...
// Field metadata describes the current real schema, including unconfigured fields.
export function fieldPolicyColumns(configuration: FieldPolicies) {
  return configuration.fields.flatMap(field => field.column_type === "unsupported" ? [] : [{ name: field.field_name, type: field.column_type, nullable: field.nullable, generated: field.generated }]);
}
