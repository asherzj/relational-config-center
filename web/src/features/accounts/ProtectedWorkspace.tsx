...
const WorkspaceReady = createContext(false);
export function useWorkspaceReady() { return useContext(WorkspaceReady); }
...
export function ProtectedWorkspace() {
  ...
  return <WorkspaceIdentity value={identity}><WorkspaceRecovery value={recoveryVersion}><WorkspaceReady value={!hidden}>
  ...
  </WorkspaceReady></WorkspaceRecovery></WorkspaceIdentity>;
}
