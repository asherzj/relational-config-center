...
it("已有草稿去向只列出当前可编辑的草稿",async()=>{
 ...
 const summary=(id:string,extra:object={})=>({notification:{sequence:"0",unread:false,pending:false},id,release_type:"STANDARD",table_flows:[],missing_flow_tables:[],title:"消息模板草稿",table_names:["notification_templates"],applicant_id:testAdminIdentity.account.id,state:"DRAFT",version:"1",created_at:"2026-09-08T00:00:00Z",updated_at:"2026-09-08T00:00:00Z",allowed_actions:["edit"],item_count:1,operation_counts:{MODIFY:1},approvals:[],approval_context:{revision:"draft",tables:[],approvable_tables:[]},...extra});
 vi.stubGlobal("fetch",withAdminSession(vi.fn(async(input,init)=>{
