...
const actionLabels:Record<string,string>={CREATE:"创建了草稿",EDIT:"修改了草稿",UPDATE:"修改了草稿",SUBMIT:"提交了审批",APPROVE:"批准了发布单",REJECT:"拒绝了发布单",CANCEL:"取消了发布单",COPY:"复制了新草稿",REPREPARE:"重新准备了发布单",EXECUTE:"发布到数据库",COMPLETE:"完结了发布单",ROLLBACK_REQUEST:"申请了回滚",QUICK_ROLLBACK:"执行了快速回滚",ROLLED_BACK:"完成了回滚",ROLLBACK_CANCELLED:"取消了回滚申请",ROLLBACK_REJECTED:"回滚申请被拒绝"};
