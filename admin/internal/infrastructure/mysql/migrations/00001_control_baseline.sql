...
-- +goose Up
CREATE TABLE IF NOT EXISTS `rcc_query_policies` (
...
CREATE TABLE IF NOT EXISTS `rcc_mutation_policies` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(100) NOT NULL,
  `name` varchar(100) NOT NULL,
  `description` varchar(500) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `rcc_table_policies` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS rcc_login_sessions (
...
CREATE TABLE IF NOT EXISTS rcc_preauth_credentials (
 token_hash CHAR(64) CHARACTER SET ascii COLLATE ascii_bin PRIMARY KEY,
 csrf_hash CHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
 expires_at DATETIME(6) NOT NULL,
 KEY ix_rcc_preauth_expiry(expires_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS rcc_auth_rate_limits (
...
CREATE TABLE IF NOT EXISTS rcc_auth_control_lock (id INT PRIMARY KEY) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
INSERT INTO rcc_auth_control_lock(id) VALUES (1) ON DUPLICATE KEY UPDATE id=id;
