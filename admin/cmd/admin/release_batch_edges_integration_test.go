...
func batchEdgeApplication(t *testing.T, setup ...string) (*adminApplication, *sql.DB) {
	t.Helper()
	ctx, driver := startIntegrationMySQLWithRequirement(t, true, "../../../deploy/mysql/init/001-schema.sql", "testdata/006-mutation-fixture.sql", "testdata/010-record-identity-fixture.sql")
	root := *driver
	root.User = "root"
