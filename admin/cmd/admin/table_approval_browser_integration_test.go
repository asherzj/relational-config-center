...
func TestTableApprovalBrowserSystemPath(t *testing.T) {
	...
	browser := exec.Command("node", filepath.Join(web, "e2e/table-approvals.cjs"))
	browser.Dir = web
	...
	t.Logf("table approval browser: %s", result)
}
