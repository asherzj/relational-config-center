...
CREATE TABLE draft_browser_items_firefox LIKE draft_browser_items;
INSERT INTO draft_browser_items_firefox(id,code,label) SELECT id,code,label FROM draft_browser_items;

CREATE TABLE draft_browser_items_webkit LIKE draft_browser_items;
INSERT INTO draft_browser_items_webkit(id,code,label) SELECT id,code,label FROM draft_browser_items;
