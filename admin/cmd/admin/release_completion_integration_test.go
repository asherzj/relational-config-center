...
func TestReleaseCompletionRetainsKnownTargets(t *testing.T) {
	...
	path := approvePublication(t, app, reviewer, `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"0","content":{"label":"published"}}]}`, "completion-known")
	...
	conflict := rollbackOrderResponse(t, releaseRequest(t, app, "POST", "/api/v1/release-orders", `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"1","content":{"label":"overlap"}}]}`, "completion-overlap-create"), 201)
	...
	other := approvePublication(t, app, reviewer, `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"200","expected_record_version":"0","content":{"label":"unrelated"}}]}`, "completion-other")
...
func TestReleaseCompletionOrdinaryRollbackClosesBothOrders(t *testing.T) {
	...
	enableMutationPolicy(t, app, "mutation_add_items", mutationPolicyFixture{AllowAdd: true, AllowModify: true, AllowDelete: true})
	reviewer := publicationFixtureReviewer(t, app)
	path := approvePublication(t, app, reviewer, `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"0","content":{"label":"published"}}]}`, "completion-ordinary")
	...
	approvePublication(t, app, reviewer, `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"2","content":{"label":"available"}}]}`, "completion-after-rollback")
}
...
func TestReleaseCompletionReleasesWithoutRepublishing(t *testing.T) {
	...
	enableMutationPolicy(t, app, "mutation_add_items", mutationPolicyFixture{AllowAdd: true, AllowModify: true, AllowDelete: true})
	path := approvePublication(t, app, publicationFixtureReviewer(t, app), `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"0","content":{"label":"published"}}]}`, "completion-release")
	...
	draft := approvePublication(t, app, publicationFixtureReviewer(t, app), `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"1","content":{"label":"next"}}]}`, "completion-after")
...
func TestReleaseCompletionProtectsActualAndDeletedIDs(t *testing.T) {
	...
	enableMutationPolicy(t, app, "mutation_add_items", mutationPolicyFixture{AllowAdd: true, AllowModify: true, AllowDelete: true})
	path := approvePublication(t, app, publicationFixtureReviewer(t, app), `{"table_name":"mutation_add_items","items":[{"operation":"ADD","content":{"code":"generated","label":"published"}},{"operation":"DELETE","id":"100","expected_record_version":"0","content":{}}]}`, "completion-identities")
	...
	for index, item := range []string{
		...
		draft := rollbackOrderResponse(t, releaseRequest(t, app, "POST", "/api/v1/release-orders", `{"table_name":"mutation_add_items","items":[`+item+`]}`, fmt.Sprintf("completion-identity-create-%d", index)), 201)
...
func TestReleaseCompletionRolesConcurrencyAndReplay(t *testing.T) {
	...
	enableMutationPolicy(t, app, "mutation_add_items", mutationPolicyFixture{AllowAdd: true, AllowModify: true, AllowDelete: true})
	path := approvePublication(t, app, publicationFixtureReviewer(t, app), `{"table_name":"mutation_add_items","items":[{"operation":"ADD","content":{"code":"race","label":"published"}}]}`, "completion-race")
...
func TestReleaseCompletionPersistenceFailureIsAtomic(t *testing.T) {
	...
	enableMutationPolicy(t, app, "mutation_add_items", mutationPolicyFixture{AllowAdd: true, AllowModify: true, AllowDelete: true})
	path := approvePublication(t, app, publicationFixtureReviewer(t, app), `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"0","content":{"label":"published"}}]}`, "completion-atomic")
	original := rollbackOrderResponse(t, releaseRequest(t, app, "POST", path+"/execute", `{"expected_version":"3"}`, "completion-atomic-execute"), 200)
	conflict := rollbackOrderResponse(t, releaseRequest(t, app, "POST", "/api/v1/release-orders", `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"1","content":{"label":"next"}}]}`, "completion-atomic-conflict"), 201)
...
func TestReleaseCompletionRequiresTrustedPublicationOnReadAndReplay(t *testing.T) {
	...
	path := approvePublication(t, app, publicationFixtureReviewer(t, app), `{"table_name":"mutation_add_items","items":[{"operation":"ADD","content":{"code":"integrity","label":"trusted"}}]}`, "completion-integrity")
...
func TestReleaseCompletionAtPublicationCapacityPreservesRollback(t *testing.T) {
	...
	reviewer := publicationFixtureReviewer(t, app)
	path := approvePublication(t, app, reviewer, `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"0","content":{"label":"published"}}]}`, "completion-capacity")
	...
	approvePublication(t, app, reviewer, `{"table_name":"mutation_add_items","items":[{"operation":"MODIFY","id":"100","expected_record_version":"2","content":{"label":"available"}}]}`, "completion-capacity-after")
}
