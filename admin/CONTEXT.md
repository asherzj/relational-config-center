...
- [Multi-table draft targets and execution decision](../docs/adr/0024-multitable-drafts-reserve-targets-and-record-executions.md): the accepted model for multi-table orders, draft reservations, and original-order rollback.
